...
# Note: pyproject.toml declares `windows-curses; sys_platform == 'win32'`,
# so the line above already pulls it in automatically on Windows - Python's
# stdlib `curses` (used by the TUI) doesn't exist here otherwise. No
